...
Se você precisa de uma licença mais permissiva para um caso específico, entre em contato com os mantenedores do projeto para discussão.

## Contato

Para questões sobre licenciamento ou contribuições, abra uma issue no repositório ou entre em contato com os mantenedores.
